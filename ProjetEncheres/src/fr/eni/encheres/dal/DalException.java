...
public class DalException extends Exception {
	...
	public static final String DAL_NO_IMPLEMENTATION = "Methode non implement� ou non implementable";
	public static final String DAL_ERROR_READING_DATA = "Methode non implement� ou non implementable";
	public static final String DAL_ERROR_WRITING_DATA = "Methode non implement� ou non implementable";
